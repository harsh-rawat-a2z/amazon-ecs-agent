...
// AllIPV4VPCCIDRBlocks mocks base method
func (m *MockEC2MetadataClient) AllIPV4VPCCIDRBlocks(arg0 string) ([]*net.IPNet, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AllIPV4VPCCIDRBlocks", arg0)
	ret0, _ := ret[0].([]*net.IPNet)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// AllIPV4VPCCIDRBlocks indicates an expected call of AllIPV4VPCCIDRBlocks
func (mr *MockEC2MetadataClientMockRecorder) AllIPV4VPCCIDRBlocks(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AllIPV4VPCCIDRBlocks", reflect.TypeOf((*MockEC2MetadataClient)(nil).AllIPV4VPCCIDRBlocks), arg0)
}
